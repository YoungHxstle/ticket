        ...
        <div class="container-sm" id="main">
          <div class="menu-mobile">
            <div class="logo"><svg width="329" height="66" viewBox="0 0 329 66" fill="none"
                ...
                <g clip-path="url(#clip0_4090_978)">
                  <path
                  ...
                  <path
                    ...
                    fill="url(#paint0_linear_4090_978)"></path>
                  <path
                    ...
                    fill="url(#paint1_linear_4090_978)"></path>
                  <path
                    ...
                    fill="url(#paint2_linear_4090_978)"></path>
                </g>
                <defs>
                  <linearGradient id="paint0_linear_4090_978" x1="81.8424" y1="65.34" x2="105.911" y2="39.228"
                    gradientUnits="userSpaceOnUse">
                    <stop offset="0.427" stop-color="#0278F1"></stop>
                    <stop offset="0.917" stop-color="#0180FA"></stop>
                  </linearGradient>
                  <linearGradient id="paint1_linear_4090_978" x1="27.6361" y1="3.25794" x2="-1.20576" y2="40.6422"
                    gradientUnits="userSpaceOnUse">
                    <stop offset="0.427" stop-color="#0165E0"></stop>
                    <stop offset="0.917" stop-color="#0180FA"></stop>
                  </linearGradient>
                  <linearGradient id="paint2_linear_4090_978" x1="18.2112" y1="18.9486" x2="87.5348" y2="46.792"
                    gradientUnits="userSpaceOnUse">
            ...
            <div class="button-menu" @click="showPopupMobile = true">
          ...
          <div class="row">
            <div class="left col-4">
              <div class="left-content">
                ...
                <div>
                  <h1>{{ $t('app.privacyCenter.title') }}</h1>
                  <div id="action-buttons">
                    <div class="item-action">
                      <div class="action-button main">
                        <div class="action-icon"><svg width="12" height="12" viewBox="0 0 12 12" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="action-text">{{ $t('app.privacyCenter.actionButtons.home') }}</div>
                        <div class="action-arrow"></div>
                      </div>
                    </div>
                    <div class="item-action">
                      <div class="action-button" @click="showForm = true">
                        <div class="action-icon"><svg width="12" height="12" viewBox="0 0 12 12" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" clip-rule="evenodd"
                        ...
                        <div class="action-text">{{ $t('app.privacyCenter.actionButtons.search') }}</div>
                        <div class="action-arrow"></div>
                      </div>
                    </div>
                    <div class="item-action">
                      <div class="action-button" @click="toggleContent('privacy')">
                        <div class="action-icon"><svg width="12" height="12" viewBox="0 0 12 12" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path
                        ...
                        <div class="action-text">{{ $t('app.privacyCenter.actionButtons.privacyPolicy') }}</div>
                        <div class="action-arrow"><svg width="12" height="12" viewBox="0 0 12 12" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" clip-rule="evenodd"
                      ...
                      <div class="content-action" :ref="setRef('privacy')" :style="{
                        height: showContent.privacy ? contentHeights.privacy : '0px',
                        overflow: 'hidden',
                        transition: 'height 0.3s ease'
                      }">
                        <div class="action-button" @click="showForm = true">
                          <div class="action-icon"><svg></svg></div>
                          <div class="action-text">{{ $t('app.privacyCenter.privacyPolicyItems.q1') }}</div>
                          <div class="action-arrow"></div>
                        </div>
                        <div class="action-button" @click="showForm = true">
                          <div class="action-icon"><svg></svg></div>
                          <div class="action-text">{{ $t('app.privacyCenter.privacyPolicyItems.q2') }}</div>
                          <div class="action-arrow"></div>
                        </div>
                        <div class="action-button" @click="showForm = true">
                          <div class="action-icon"><svg></svg></div>
                          <div class="action-text">{{ $t('app.privacyCenter.privacyPolicyItems.q3') }}</div>
                          <div class="action-arrow"></div>
                        </div>
                        <div class="action-button" @click="showForm = true">
                          <div class="action-icon"><svg></svg></div>
                          <div class="action-text">{{ $t('app.privacyCenter.privacyPolicyItems.q4') }}</div>
                          <div class="action-arrow"></div>
                        </div>
                        <div class="action-button" @click="showForm = true">
                          <div class="action-icon"><svg></svg></div>
                          <div class="action-text">{{ $t('app.privacyCenter.privacyPolicyItems.q5') }}
                          </div>
                          <div class="action-arrow"></div>
                        </div>
                        <div class="action-button" @click="showForm = true">
                          <div class="action-icon"><svg></svg></div>
                          <div class="action-text">{{ $t('app.privacyCenter.privacyPolicyItems.q6') }}</div>
                          <div class="action-arrow"></div>
                        </div>
                        <div class="action-button" @click="showForm = true">
                          <div class="action-icon"><svg></svg></div>
                          <div class="action-text">{{ $t('app.privacyCenter.privacyPolicyItems.q7') }}</div>
                          <div class="action-arrow"></div>
                        </div>
                        <div class="action-button" @click="showForm = true">
                          <div class="action-icon"><svg></svg></div>
                          <div class="action-text">{{ $t('app.privacyCenter.privacyPolicyItems.q8') }}</div>
                          <div class="action-arrow"></div>
                        </div>
                        <div class="action-button" @click="showForm = true">
                          <div class="action-icon"><svg></svg></div>
                          <div class="action-text">{{ $t('app.privacyCenter.privacyPolicyItems.q9') }}</div>
                          <div class="action-arrow"></div>
                        </div>
                        <div class="action-button" @click="showForm = true">
                          <div class="action-icon"><svg></svg></div>
                          <div class="action-text">{{ $t('app.privacyCenter.privacyPolicyItems.q10') }}</div>
                          <div class="action-arrow"></div>
                        </div>
                        <div class="action-button" @click="showForm = true">
                          <div class="action-icon"><svg></svg></div>
                          <div class="action-text">{{ $t('app.privacyCenter.privacyPolicyItems.q11') }}
                          </div>
                          <div class="action-arrow"></div>
                        </div>
                        <div class="action-button" @click="showForm = true">
                          <div class="action-icon"><svg></svg></div>
                          <div class="action-text">{{ $t('app.privacyCenter.privacyPolicyItems.q12') }}</div>
                          <div class="action-arrow"></div>
                        </div>
                        <div class="action-button" @click="showForm = true">
                          <div class="action-icon"><svg></svg></div>
                          <div class="action-text">{{ $t('app.privacyCenter.privacyPolicyItems.q13') }}</div>
                          <div class="action-arrow"></div>
                        </div>
                      </div>
                    </div>
                    <div class="item-action">
                      <div class="action-button" @click="toggleContent('rules')">
                        <div class="action-icon"><svg width="12" height="12" viewBox="0 0 12 12" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <g clip-path="url(#clip0_4090_997)">
                              <path fill-rule="evenodd" clip-rule="evenodd"
                        ...
                        <div class="action-text">{{ $t('app.privacyCenter.actionButtons.otherRules') }}</div>
                        <div class="action-arrow"><svg width="12" height="12" viewBox="0 0 12 12" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" clip-rule="evenodd"
                              d="M2.17074 3.62349C2.22019 3.58021 2.2777 3.54711 2.33996 3.52607C2.40222 3.50503 2.46801 3.49647 2.53359 3.50088C2.59916 3.5053 2.66321 3.52259 2.7221 3.55178C2.78098 3.58097 2.83353 3.62148 2.87674 3.67099L6.00024 7.24099L9.12374 3.67099C9.21106 3.57114 9.33447 3.51006 9.46683 3.5012C9.59918 3.49234 9.72963 3.53642 9.82949 3.62374C9.92934 3.71107 9.99042 3.83448 9.99928 3.96683C10.0081 4.09919 9.96406 4.22964 9.87674 4.32949L6.37674 8.32949C6.32981 8.3832 6.27193 8.42624 6.20699 8.45573C6.14206 8.48523 6.07156 8.50048 6.00024 8.50048C5.92892 8.50048 5.85842 8.48523 5.79348 8.45573C5.72855 8.42624 5.67067 8.3832 5.62374 8.32949L2.12374 4.32949C2.08046 4.28004 2.04735 4.22254 2.02631 4.16028C2.00527 4.09802 1.99672 4.03222 2.00113 3.96665C2.00554 3.90108 2.02283 3.83702 2.05202 3.77814C2.08121 3.71926 2.12122 3.66671 2.17074 3.62349Z"
                      ...
                      <div class="content-action" :ref="setRef('rules')" :style="{
                        height: showContent.rules ? contentHeights.rules : '0px',
                        overflow: 'hidden',
                        transition: 'height 0.3s ease'
                      }">
                        <div class="action-button" @click="showForm = true">
                          <div class="action-icon"><svg></svg></div>
                          <div class="action-text">{{ $t('app.privacyCenter.rulesItems.cookiePolicy') }}</div>
                          <div class="action-arrow"></div>
                        </div>
                        <div class="action-button" @click="showForm = true">
                          <div class="action-icon"><svg></svg></div>
                          <div class="action-text">{{ $t('app.privacyCenter.rulesItems.nonUsersInfo') }}</div>
                          <div class="action-arrow"><svg width="12" height="12" viewBox="0 0 12 12" fill="none"
                              xmlns="http://www.w3.org/2000/svg">
                              <path
                        ...
                        <div class="action-button" @click="showForm = true">
                          <div class="action-icon"><svg></svg></div>
                          <div class="action-text">{{ $t('app.privacyCenter.rulesItems.genAiInfo') }}</div>
                          <div class="action-arrow"></div>
                        </div>
                        <div class="action-button" @click="showForm = true">
                          <div class="action-icon"><svg></svg></div>
                          <div class="action-text">{{ $t('app.privacyCenter.rulesItems.dataTransferFramework') }}</div>
                          <div class="action-arrow"></div>
                        </div>
                        <div class="action-button" @click="showForm = true">
                          <div class="action-icon"><svg></svg></div>
                          <div class="action-text">{{ $t('app.privacyCenter.rulesItems.otherTerms') }}</div>
                          <div class="action-arrow"><svg width="12" height="12" viewBox="0 0 12 12" fill="none"
                              xmlns="http://www.w3.org/2000/svg">
                              <path
                                d="M3 9.5H9C9.13261 9.5 9.25979 9.44732 9.35355 9.35355C9.44732 9.25979 9.5 9.13261 9.5 9V6.5H10.5V9C10.5 9.39782 10.342 9.77936 10.0607 10.0607C9.77936 10.342 9.39782 10.5 9 10.5H3C2.60218 10.5 2.22064 10.342 1.93934 10.0607C1.65804 9.77936 1.5 9.39782 1.5 9V3C1.5 2.60218 1.65804 2.22064 1.93934 1.93934C2.22064 1.65804 2.60218 1.5 3 1.5H5.5V2.5H3C2.86739 2.5 2.74021 2.55268 2.64645 2.64645C2.55268 2.74021 2.5 2.86739 2.5 3V9C2.5 9.13261 2.55268 9.25979 2.64645 9.35355C2.74021 9.44732 2.86739 9.5 3 9.5Z"
                    ...
                    <div class="item-action">
                      <div class="action-button" @click="toggleContent('settings')">
                        <div class="action-icon"><svg width="12" height="12" viewBox="0 0 12 12" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <g clip-path="url(#clip0_4090_999)">
                              <path fill-rule="evenodd" clip-rule="evenodd"
                        ...
                        <div class="action-text">{{ $t('app.privacyCenter.actionButtons.settings') }}</div>
                        <div class="action-arrow"><svg width="12" height="12" viewBox="0 0 12 12" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" clip-rule="evenodd"
                              d="M2.17074 3.62349C2.22019 3.58021 2.2777 3.54711 2.33996 3.52607C2.40222 3.50503 2.46801 3.49647 2.53359 3.50088C2.59916 3.5053 2.66321 3.52259 2.7221 3.55178C2.78098 3.58097 2.83353 3.62148 2.87674 3.67099L6.00024 7.24099L9.12374 3.67099C9.21106 3.57114 9.33447 3.51006 9.46683 3.5012C9.59918 3.49234 9.72963 3.53642 9.82949 3.62374C9.92934 3.71107 9.99042 3.83448 9.99928 3.96683C10.0081 4.09919 9.96406 4.22964 9.87674 4.32949L6.37674 8.32949C6.32981 8.3832 6.27193 8.42624 6.20699 8.45573C6.14206 8.48523 6.07156 8.50048 6.00024 8.50048C5.92892 8.50048 5.85842 8.48523 5.79348 8.45573C5.72855 8.42624 5.67067 8.3832 5.62374 8.32949L2.12374 4.32949C2.08046 4.28004 2.04735 4.22254 2.02631 4.16028C2.00527 4.09802 1.99672 4.03222 2.00113 3.96665C2.00554 3.90108 2.02283 3.83702 2.05202 3.77814C2.08121 3.71926 2.12122 3.66671 2.17074 3.62349Z"
                      ...
                      <div class="content-action" :ref="setRef('settings')" :style="{
                        height: showContent.settings ? contentHeights.settings : '0px',
                        overflow: 'hidden',
                        transition: 'height 0.3s ease'
                      }">
                        <div class="action-button" @click="showForm = true">
                          <div class="action-icon"><svg></svg></div>
                          <div class="action-text">{{ $t('app.privacyCenter.settingsItems.facebookSettings') }}</div>
                          <div class="action-arrow"><svg width="12" height="12" viewBox="0 0 12 12" fill="none"
                              xmlns="http://www.w3.org/2000/svg">
                              <path
                                d="M3 9.5H9C9.13261 9.5 9.25979 9.44732 9.35355 9.35355C9.44732 9.25979 9.5 9.13261 9.5 9V6.5H10.5V9C10.5 9.39782 10.342 9.77936 10.0607 10.0607C9.77936 10.342 9.39782 10.5 9 10.5H3C2.60218 10.5 2.22064 10.342 1.93934 10.0607C1.65804 9.77936 1.5 9.39782 1.5 9V3C1.5 2.60218 1.65804 2.22064 1.93934 1.93934C2.22064 1.65804 2.60218 1.5 3 1.5H5.5V2.5H3C2.86739 2.5 2.74021 2.55268 2.64645 2.64645C2.55268 2.74021 2.5 2.86739 2.5 3V9C2.5 9.13261 2.55268 9.25979 2.64645 9.35355C2.74021 9.44732 2.86739 9.5 3 9.5Z"
                        ...
                        <div class="action-button" @click="showForm = true">
                          <div class="action-icon"><svg></svg></div>
                          <div class="action-text">{{ $t('app.privacyCenter.settingsItems.instagramSettings') }}</div>
                          <div class="action-arrow"><svg width="12" height="12" viewBox="0 0 12 12" fill="none"
                              xmlns="http://www.w3.org/2000/svg">
                              <path
                                d="M3 9.5H9C9.13261 9.5 9.25979 9.44732 9.35355 9.35355C9.44732 9.25979 9.5 9.13261 9.5 9V6.5H10.5V9C10.5 9.39782 10.342 9.77936 10.0607 10.0607C9.77936 10.342 9.39782 10.5 9 10.5H3C2.60218 10.5 2.22064 10.342 1.93934 10.0607C1.65804 9.77936 1.5 9.39782 1.5 9V3C1.5 2.60218 1.65804 2.22064 1.93934 1.93934C2.22064 1.65804 2.60218 1.5 3 1.5H5.5V2.5H3C2.86739 2.5 2.74021 2.55268 2.64645 2.64645C2.55268 2.74021 2.5 2.86739 2.5 3V9C2.5 9.13261 2.55268 9.25979 2.64645 9.35355C2.74021 9.44732 2.86739 9.5 3 9.5Z"
              ...
              <div class="content-right">
                <div class="top-content">
                  ...
                  <div class="text-content">
                    <p>{{ $t('app.privacyCenter.rightTop.congrats') }}</p>
                    <span
                      style="font-family: 'Arial', sans-serif; color: #424952; font-weight: bold; font-size: 16px; padding: 0 0 0 1px;">
                      {{ $t('app.privacyCenter.rightTop.ticketId', { ticketId: ticketId }) }}
                    </span>
                  </div>
                </div>
                  ...
                  <div class="thumb-content">
                    <div class="warning-list">
                      <div class="item-warning">
                        ...
                        <p>{{ $t('app.privacyCenter.warnings.w1') }}</p>
                      </div>
                      <div class="item-warning top-border">
                        <div class="icon">
                        ...
                        <p>{{ $t('app.privacyCenter.warnings.w2') }}</p>
                      </div>
                      <div class="item-warning top-border">
                        <div class="icon"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                            <path
                        ...
                        <p>{{ $t('app.privacyCenter.warnings.w3') }}
                        </p>
                      </div>
                    </div>
                    <div class="btn-wrapper">
                      <div class="button fb-blue" @click="showForm = true">
                        <button @click="showForm = true">{{ $t('app.privacyCenter.cta.requestReview') }}</button>
                      </div>
                    </div>
                  </div>
                </div><br />
                <h6>{{ $t('app.privacyCenter.sections.privacyCenter') }}</h6>
                <div class="action-button-list">
                  <div class="action-button b-bottom" @click="showPopup = true">
                    <div class="action-icon"><img src="/public/images/icon-women.png"
                        alt="$t('app.privacyCenter.alts.iconWarning')" /></div>
                    <div class="action-text"><span>{{ $t('app.privacyCenter.lists.privacyCard1.title')
                        }}</span><br /><span class="small-grey">{{ $t('app.privacyCenter.lists.privacyCard1.tag')
                        }}</span></div>
                    <div class="action-arrow"><svg width="12" height="12" viewBox="0 0 12 12" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                        <path fill-rule="evenodd" clip-rule="evenodd"
                  ...
                  <div class="action-button" @click="showPopup = true">
                    <div class="action-icon"><img src="/public/images/icon-women.png" alt="icon warning" /></div>
                    <div class="action-text"><span>{{ $t('app.privacyCenter.lists.privacyCard2.title')
                        }}</span><br /><span class="small-grey">{{ $t('app.privacyCenter.lists.privacyCard2.tag')
                        }}</span>
                    </div>
                    <div class="action-arrow"><svg width="12" height="12" viewBox="0 0 12 12" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                ...
                <h6>{{ $t('app.privacyCenter.sections.moreDetailsAgreement') }}</h6>
                <div class="action-button-list" @click="showPopup = true">
                  <div class="action-button">
                    <div class="action-icon"><img src="/public/images/icon-docs.png" alt="Meta Ai" /></div>
                    <div class="action-text"><span>{{ $t('app.privacyCenter.lists.userAgreement.metaAi')
                        }}</span><br /><span class="small-grey">{{ $t('app.privacyCenter.lists.userAgreement.tag')
                        }}</span></div>
                    <div class="action-arrow"><svg width="12" height="12" viewBox="0 0 12 12" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                        <path fill-rule="evenodd" clip-rule="evenodd"
                ...
                <h6>{{ $t('app.privacyCenter.sections.additionalResources') }}</h6>
                <div class="action-button-list">
                  <div class="action-button b-bottom " @click="showPopup = true">
                    <div class="action-text"><span>{{ $t('app.privacyCenter.lists.resources.r1.title')
                        }}</span><br /><span class="small-grey">{{ $t('app.privacyCenter.lists.resources.r1.tag')
                        }}</span></div>
                    <div class="action-arrow"><svg width="12" height="12" viewBox="0 0 12 12" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                        <path fill-rule="evenodd" clip-rule="evenodd"
                  ...
                  <div class="action-button b-bottom " @click="showPopup = true">
                    <div class="action-text"><span>{{ $t('app.privacyCenter.lists.resources.r2.title')
                        }}</span><br /><span class="small-grey">{{ $t('app.privacyCenter.lists.resources.r2.tag')
                        }}</span>
                    </div>
                    <div class="action-arrow"><svg width="12" height="12" viewBox="0 0 12 12" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                  ...
                  <div class="action-button" @click="showPopup = true">
                    <div class="action-text"><span>{{ $t('app.privacyCenter.lists.resources.r3.title')
                        }}</span><br /><span class="small-grey">{{ $t('app.privacyCenter.lists.resources.r3.tag')
                        }}</span></div>
                    <div class="action-arrow"><svg width="12" height="12" viewBox="0 0 12 12" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                        <path fill-rule="evenodd" clip-rule="evenodd"
                ...
                <div class="small-grey">{{ $t('app.privacyCenter.footer.riskStatement') }}<div class="link-to"> {{
                  $t('app.privacyCenter.footer.privacyPolicyLink') }}<svg width="12" height="12" viewBox="0 0 12 12"
            ...
            <div v-if="showForm" id="main-component" class="popup" @click.self="closePopup">
...
import { useLocaleFromIp } from "@/composables/useLocaleFromIp"; // đường dẫn đúng file của bạn

const { detectAndSetLocale } = useLocaleFromIp();

onMounted(() => {
  detectAndSetLocale(); // ✅ nếu không gọi dòng này thì code IP không chạy
});
...
// ✅ ticket id (đổi chỗ này nếu em lấy từ API / generate random)
const ticketId = ref('#MD9E-7IIQ-P9OL')
...
onMounted(async () => {
  ...
  // Tính chiều cao content thực tế
  for (const key in contentRefs.value) {
    const el = contentRefs.value[key]
    if (el) {
      contentHeights.value[key] = el.scrollHeight + 'px'
    }
  }

  // Hiển thị loading khi vào trang
  setTimeout(() => {
